...
const Medications: React.FC = () => {
		...
		() => [
			...
			},
			{
				...
				sorter: (a: MedicationInPharmacy, b: MedicationInPharmacy) => {
					...
					return (pharmacyA?.pharmacyAddress || '').localeCompare(
						pharmacyB?.pharmacyAddress || ''
					)
				},
			},
		],
	...
	const columns = useMemo(
		() => [...baseColumns, ...(selectedPharmacyId ? pharmacyColumns : [])],
		[baseColumns, pharmacyColumns, selectedPharmacyId]
	)
